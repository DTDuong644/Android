...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ứng dụng Quản trị'); ?></title>
...
<body>
    <nav class="navbar-top">
        <div class="logo">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo"> </div>
    ...
    <div class="d-flex">
        <div class="sidebar">
            ...
            <a href="<?php echo e(route('locations.index')); ?>"><i class="fas fa-map-marker-alt"></i> Quản lý địa điểm</a>
            <a href="<?php echo e(route('violations.index')); ?>"><i class="fas fa-exclamation-triangle"></i> Quản lý vi phạm</a>
            <a href="<?php echo e(route('ratings.index')); ?>"><i class="fas fa-pencil-alt"></i> Đánh giá chuyến đi</a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('statistics')); ?>">
            ...
            <a href=<?php echo e(route('applications.index')); ?>><i class="fas fa-file-alt"></i> Duyệt hồ sơ</a>
        </div>
...
</html><?php /**PATH C:\Laravel\quanlynguoidung\resources\views/app.blade.php ENDPATH**/ ?>